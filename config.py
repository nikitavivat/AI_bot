...
Gemini_Flash_free_per_day = 100
Gemini_Pro_free_per_day = 3
...
#                        'Gemini Flash - 10 запросов', 'Gemini PRO - 11 запросов']
tariff_plans = ['tariff_gpt4o_10', 'tariff_gp_10', 'tariff_dalle3_10']
name_of_tariff_plans = ['GPT 4o 10 запросов - 99 руб', 'Gemini Pro 10 запросов - 99 руб', 'DALL-E 3 10 запросов - 99 руб']
